        ...
        <div>
            ...
            <div className='section has-background-light'>
                <div className='container is-flex is-justify-content-center '>
                    ...
                    <div>
                    <p className='content has-text-centered mx-6 my-3'>We are a nonprofit project founded in May 2021 to promote health and welfare among historically underserved patients by providing multilingual resources such as our doctor finder, affordable care finder, and patient guide. Our mission is to help connect patients with the affordable, culturally competent healthcare they need. <br></br> For transparency and accountability, we provide additional information on our <a href='/finances'>finances</a>, <a href='/governance'>governance</a>, and <a href='/policies'>policies</a>. We are entirely funded by two unconditional grants from <a href="https://entrepreneurship.brown.edu/resources/grants-funding/">Brown University</a>. We are overseen by an inclusive advisory board including health providers, patients, advocates, and students. If you have any suggestions or thoughts on improving our resources and programs, please
