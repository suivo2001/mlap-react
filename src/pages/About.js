        ...
        <div>
            ...
            <div className='section has-background-light'>
                <div className='container is-flex is-justify-content-center '>
                    ...
                    <div>
                    <p className='content has-text-centered mx-6 my-3'>We are a nonprofit project founded in May 2021 to promote health and welfare among historically underserved patients by providing multilingual resources such as our doctor finder, affordable care finder, and patient guide. Our mission is to help connect patients with the affordable, culturally competent healthcare they need.</p>
