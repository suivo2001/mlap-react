...
const Contact = () => {
    return (
        <div>
            ...
            <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSd0UqrzohP7OOnqjTmauwHvWe2cVyLlLLvIRz7ppg8Y83EX_g/viewform?embedded=true" width="800" height="1050" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
            </div>
        </div>
    )
}
