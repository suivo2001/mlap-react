            ...
            <div className='section has-background-light'>
                <div className='container is-flex is-justify-content-center '>
                    <div>
                        ...
                        <p className='content has-text-centered mx-6 my-3'>We are thankful for our physician and patient advisors from across the United States who review our resources, including:
                        <ul>
